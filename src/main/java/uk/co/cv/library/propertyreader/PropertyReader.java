package uk.co.cv.library.propertyreader;
...
public class PropertyReader {
    ...
    */
    ...
    public String getProperty(String propertyName){
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir")+"/src/test/java/uk/co/cv/library/resources/propertiesfile/config.properties");
